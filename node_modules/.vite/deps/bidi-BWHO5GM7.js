...
var require_BrowsingContextProcessor = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/context/BrowsingContextProcessor.js"(exports) {
    ...
    var protocol_js_1 = require_protocol();
    var _browserCdpClient, _browsingContextStorage, _eventManager, _BrowsingContextProcessor_instances, onContextCreatedSubscribeHook_fn;
    var BrowsingContextProcessor = class {
      ...
      async setViewport(params) {
        if (params.userContexts === void 0 && params.context === void 0) {
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/session/SessionProcessor.js"(exports) {
    ...
    var SessionProcessor = class {
      ...
      async subscribe(params, channel = {}) {
        const subscription = await __privateGet(this, _eventManager).subscribe(params.events, params.contexts ?? [], params.userContexts ?? [], channel);
        return {
          subscription
        };
      }
...
var require_CommandProcessor = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/CommandProcessor.js"(exports) {
    ...
    var _bluetoothProcessor, _browserProcessor, _browsingContextProcessor, _cdpProcessor, _inputProcessor, _networkProcessor, _permissionsProcessor, _scriptProcessor, _sessionProcessor, _storageProcessor, _webExtensionProcessor, _parser, _logger, _CommandProcessor_instances, processCommand_fn, processTargetParams_fn;
    ...
    processCommand_fn = async function(command) {
      ...
      switch (command.method) {
        ...
        case "cdp.getSession":
          (_a3 = __privateGet(this, _logger)) == null ? void 0 : _a3.call(this, log_js_1.LogType.debugWarn, `Legacy '${command.method}' command is deprecated and will not supported soon. Use 'goog:${command.method}' instead.`);
          return __privateGet(this, _cdpProcessor).getSession(__privateGet(this, _parser).parseGetSessionParams(command.params));
        case "cdp.resolveRealm":
          (_b = __privateGet(this, _logger)) == null ? void 0 : _b.call(this, log_js_1.LogType.debugWarn, `Legacy '${command.method}' command is deprecated and will not supported soon. Use 'goog:${command.method}' instead.`);
          return __privateGet(this, _cdpProcessor).resolveRealm(__privateGet(this, _parser).parseResolveRealmParams(command.params));
        case "cdp.sendCommand":
          (_c = __privateGet(this, _logger)) == null ? void 0 : _c.call(this, log_js_1.LogType.debugWarn, `Legacy '${command.method}' command is deprecated and will not supported soon. Use 'goog:${command.method}' instead.`);
          return await __privateGet(this, _cdpProcessor).sendCommand(__privateGet(this, _parser).parseSendCommandParams(command.params));
        ...
        case "session.unsubscribe":
          return await __privateGet(this, _sessionProcessor).unsubscribe(__privateGet(this, _parser).parseUnsubscribeParams(command.params), command.channel);
...
var require_NavigationTracker = __commonJS({
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/context/NavigationTracker.js"(exports) {
    ...
    var _eventManager2, _logger, _loaderIdToNavigationsMap, _browsingContextId2, _currentNavigation, _pendingNavigation, _isInitialNavigation, _NavigationTracker_instances, getNavigationForFrameNavigated_fn;
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/context/BrowsingContextImpl.js"(exports) {
    ...
    initListeners_fn = function() {
      ...
      __privateGet(this, _cdpTarget).cdpClient.on("Page.javascriptDialogOpening", (params) => {
        var _a4;
        const promptType = __privateMethod(_a4 = _a3, _BrowsingContextImpl_static, getPromptType_fn).call(_a4, params.type);
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/modules/session/EventManager.js"(exports) {
    ...
    getBufferedEvents_fn = function(eventName, contextId, channel) {
      ...
      if (contextId === null) {
        ...
        )).map((_contextId2) => __privateMethod(this, _EventManager_instances, getBufferedEvents_fn).call(this, eventName, _contextId2, channel)).forEach((events) => result.push(...events));
      }
  ...
  "node_modules/chromium-bidi/lib/cjs/bidiMapper/BidiServer.js"(exports) {
    ...
    var _BidiServer = class _BidiServer extends EventEmitter_js_1.EventEmitter {
      constructor(bidiTransport, cdpConnection, browserCdpClient, selfTargetId, defaultUserContextId, parser, logger) {
        ...
        __privateSet(this, _eventManager, new EventManager_js_1.EventManager(__privateGet(this, _browsingContextStorage), userUserContextStorage));
...
puppeteer-core/lib/esm/puppeteer/bidi/bidi.js:
   ...
   *)
*/
//# sourceMappingURL=bidi-BWHO5GM7.js.map
